<?php
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  $script["name"] = "prived-ctrl.inc.php v1 emnili";
  $Script["desc"] = "prived - kontroll funktion";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if ( array_key_exists($environment["kategorie"], $cfg["prived"]["function"]) ) {
        include $pathvars["moduleroot"].$cfg["prived"]["subdir"]."/".$cfg["prived"]["name"]."-".$environment["kategorie"].".inc.php";
    } else {
        include $pathvars["moduleroot"].$cfg["prived"]["subdir"]."/".$cfg["prived"]["name"]."-list.inc.php";
    }
