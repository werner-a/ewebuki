<?php
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// leer-details.inc.php v1 chaot
// leer - details funktion
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if ( $cfg["leer"]["right"] == "" || priv_check('', $cfg["leer"]["right"]) ) {
        ...
        $ausgaben["link_edit"] = $cfg["leer"]["basis"]."/edit,".$environment["parameter"][1].".html";
        $ausgaben["link_list"] = $cfg["leer"]["basis"]."/list.html";
        #$mapping["navi"] = "leer";
