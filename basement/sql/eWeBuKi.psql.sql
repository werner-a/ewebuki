...
--
-- Tabellenstruktur fuer auth_special
--
...
CREATE TABLE auth_special (
    ...
    sdb character varying(10) DEFAULT ''::character varying NOT NULL,
...
INSERT INTO site_text VALUES ('de', 'abort', '-1', '-555504947.rights', '/admin/menued', 'rights', '0', 'Zurück');
INSERT INTO site_text VALUES ('de', 'database', '-1', '-555504947.rights', '/admin/menued', 'rights', '0', 'Datenbank:');
INSERT INTO site_text VALUES ('de', 'path', '-1', '-555504947.rights', '/admin/menued', 'rights', '0', 'Pfad: ');
...
SELECT pg_catalog.setval('auth_special_sid_seq', (select case when max(sid)>0 then max(sid)+1 else 1 end from auth_special), false);
