...
*/
//////////////////////////////////////////////////////////////////////////////////////
// inhalte fuer die marken, nur hier aendern !!!!
// wenn das jeweilige template der startseite drin bleiben soll, variable leer lassen
switch($environment[katid]){

    case "irgendwas":
#       $mapping[main]="anderes_template";
#       $mapping[addon]="anderes_template";
        break;

    default:
   // katid wird im hauptscript in ${main} eingespult
