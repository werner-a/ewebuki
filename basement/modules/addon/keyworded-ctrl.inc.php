<?php
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  $script["name"] = "$Id: keyworded-ctrl.inc.php 1131 2007-12-12 08:45:50Z chaot $";
  $Script["desc"] = "seiten verschlagworten";
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if ( $cfg["keyworded"]["iconpath"] == "" ) $cfg["keyworded"]["iconpath"] = "/images/default/";
    ...
    if ( is_array($cfg["keyworded"]["function"][$environment["kategorie"].",shared"]) ) {
        foreach ( $cfg["keyworded"]["function"][$environment["kategorie"].",shared"] as $value ) {
    ...
    if ( array_key_exists($environment["kategorie"], $cfg["keyworded"]["function"]) ) {
        include $pathvars["moduleroot"].$cfg["keyworded"]["subdir"]."/".$cfg["keyworded"]["name"]."-".$environment["kategorie"].".inc.php";
    } else {
        include $pathvars["moduleroot"].$cfg["keyworded"]["subdir"]."/".$cfg["keyworded"]["name"]."-list.inc.php";
    }
