        ...
        function sitemap($refid, $art = "", $modify = "", $self = "") {
            ...
            while ( $array = $db -> fetch_array($result,1) ) {
                ...
                if ( $right == -1 ) {
                    ...
                    // alle punkte ausblenden ausser hauptpunkte
                    if ( $array["refid"] > 0 ) {
                    $stil = "id=".$array["mid"]." style=\"display:none\" class=".$refid;
                    } else {
                    $stil ="";
                    }
                    $sql1 = "SELECT mid FROM site_menu where refid='".$array["mid"]."'";
                    $result1  = $db -> query($sql1);
                    if ( $db -> num_rows($result1) > 0 ) {
                        $plus = "<a href=javascript:getElementsByClassName(".$array["mid"].",'manu')>+</a>";
                    } else {
                        $plus = "";
                    }

                    $tree .= "<tr ".$stil." bgcolor=\"".$cfg["color"]["set"]."\">\n";
                    ...
                    $tree .= "<td>".$plus."</td><td width=\"100%\">".$level.$ankerpos."<a class=\"\" href=".$href."?marke=".$array[mid]."><img src=\"".$cfg["iconpath"]."sitemap.png\" width=\"16\" height=\"16\" align=\"absbottom\" border=\"0\"><img src=\"".$pathvars["images"]."pos.png\" width=\"3\" height=\"1\" align=\"absbottom\" border=\"0\">".$array["label"]."</a>".$extern."</td>\n";
