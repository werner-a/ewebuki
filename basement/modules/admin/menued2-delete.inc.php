...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if ( $cfg["menued"]["modify"]["delete"][2] == "" || priv_check(make_ebene($environment["parameter"][1]), $cfg["menued"]["modify"]["delete"][2] ) || ($cfg["auth"]["menu"]["menued"][2] == -1 &&  priv_check('', $cfg["menued"]["modify"]["delete"][2],$specialvars["dyndb"] ) ) ) {
