...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if ( $wizard_name == "termine" ) {
        ...
        $sql = "Select Cast(SUBSTR(content,POSITION('[SORT]' IN content)+6,POSITION('[/SORT]' IN content)-POSITION('[SORT]' IN content)-6) AS DATETIME ) AS date from site_text where tname ='".$environment["parameter"][2]."' ORDER BY version DESC";
        $result = $db -> query($sql);
